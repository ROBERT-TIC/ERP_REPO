...
{
    public partial class AGENDAR_OBRA : Form   //CLASE PRINCIPAL DEL FORMULARIO ACTUAL
    {
        public AGENDAR_OBRA()
        {
        ...
        private void filtrar_coordinador()
        {
            ...
            while (registro.Read())
            {
                ...
                NOMBRE.Items.Add(registro["NOMBRE"].ToString());   //MUESTRA EN LISTA DESPLEGABLE LOS DATOS ANTES CONSULTADOS
        ...
        private void altoButton1_Click(object sender, EventArgs e)
        {
            ...
            int valoraev = idv.Next(1, 500);    //ALEATORIO DE DATOS 
