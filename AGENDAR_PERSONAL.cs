...
{
    public partial class AGENDAR_PERSONAL : Form   //CLASE PRINCIPAL DEL FORMULARIO ACTUAL
    {
        public AGENDAR_PERSONAL()
        {
        ...
        private void filtrar_coordinador()
        {
            ...
            MySqlCommand comando = new MySqlCommand("SELECT DISTINCTROW NOMBRE FROM pdr_personal1 WHERE AREA LIKE '%TÉCNICO%' ORDER BY NOMBRE ASC", CONEXION);   //QUERY DE CONSULTA
            CONEXION.Open();
        ...
        private void altoButton1_Click(object sender, EventArgs e)
        {
            ...
            string lieev = "LIE-S.EV" + valoraev.ToString();  //DATOS ALEATORIOS 
            ...
            while (consulta.Read())
            {
                ...
                CONEXION2.Close();  //CIERRA CONEXION 
